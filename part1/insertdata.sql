...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES
    ...
    ((SELECT dog_id FROM Dogs WHERE name = 'Charlie' AND owner_id = (SELECT user_id FROM Users WHERE username = 'leotran')), '2025-06-11 14:00:00', 30, 'Kil', 'completed'),
    ((SELECT dog_id FROM Dogs WHERE name = 'Daisy' AND owner_id = (SELECT user_id FROM Users WHERE username = 'leotran')), '2025-06-12 07:30:00', 45, 'Kilburn', 'open');